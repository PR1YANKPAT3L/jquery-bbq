/*
* jQuery BBQ: Back Button & Query Library - v1.3.1 
* http://benalman.com/projects/jquery-bbq-plugin/
* 
* took pre from github, made it jQuery 1.9 comp and compiled usign google closure-compiler
...
"")+A);d=setTimeout(l,b.fn[k].delay)}var s={},d,f=h(),x=function(b){return b},y=x,q=x;s.start=function(){d||l()};s.stop=function(){d&&clearTimeout(d);d=r};document.all&&!v&&function(){var d,f;s.start=function(){d||(f=(f=b.fn[k].src)&&f+h(),d=b('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){f||y(h());l()}).attr("src",f||"javascript:0").insertAfter("body")[0].contentWindow,w.onpropertychange=function(){try{"title"===event.propertyName&&(d.document.title=w.title)}catch(b){}})};
s.stop=x;q=function(){return h(d.location.href)};y=function(f,l){var h=d.document,m=b.fn[k].domain;f!==l&&(h.title=w.title,h.open(),m&&h.write('<script>document.domain="'+m+'"\x3c/script>'),h.close(),d.location.hash=f)}}();return s}()})(jQuery,this);
